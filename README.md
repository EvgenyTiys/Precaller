...
- **История тренировок** с просмотром истории ввода каждого фрагмента и графиком изменения суммарного Манхеттенского расстояния
...
- Просматривайте историю всех тренировок для каждого текста
- Выбирайте фрагмент для просмотра детальной истории его ввода
- График изменения суммарного Манхеттенского расстояния показывает прогресс по всем фрагментам текста
- Если фрагмент не был записан в тренировке, его расстояние считается равным нулю
...
- `GET /api/training/text/:textId/distance-chart` - Получить данные графика суммарного Манхеттенского расстояния по всем тренировкам текста
- `GET /api/training/fragment/:fragmentId/history` - Получить историю ввода фрагмента
